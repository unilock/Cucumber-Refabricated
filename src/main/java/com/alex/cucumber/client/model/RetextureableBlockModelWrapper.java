package com.alex.cucumber.client.model;
...
public class RetextureableBlockModelWrapper extends BlockModel {
    ...
    public RetextureableBlockModelWrapper(BlockModel model) {
        super(model.parentLocation, model.getElements(), model.textureMap, model.hasAmbientOcclusion, model.getGuiLight(), model.getTransforms(), model.getOverrides());
        this.model = model;
    ...
    public RetextureableBlockModelWrapper retexture(ImmutableMap<String, String> textures) {
        ...
        var newModel = new BlockModel(this.model.parentLocation, elements,
